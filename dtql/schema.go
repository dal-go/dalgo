	...
	defs := map[string]any{
		"from": map[string]any{
			...
			"properties": map[string]any{
				"database": map[string]any{"type": "string", "minLength": 1},
				"scan":     map[string]any{"type": "object", "additionalProperties": false, "required": []any{"orderBy", "limit"}, "properties": map[string]any{"orderBy": map[string]any{"type": "array", "minItems": 1, "items": map[string]any{"$ref": "#/$defs/order"}}, "limit": map[string]any{"type": "integer", "minimum": 1}}},
