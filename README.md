...
- [Build pipeline](https://github.com/dal-go/dalgo/actions/workflows/ci.yml)
    ...
    - Go vet
    - golangci-lint
- Same [end-2-end tests](https://github.com/dal-go/dalgo/end2end) are used for all DB adapters
...
- ### [**dalgo2memory**](./dalgo2memory)
  an in-memory dalgo adapter useful for tests, examples, and local development.
...
and [end-to-end](https://github.com/dal-go/dalgo/end2end) integration tests.
