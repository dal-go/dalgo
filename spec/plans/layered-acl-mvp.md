...
**Depends-On:** 23
**Status:** in_progress
**Evidence:** dal-go/dalgo#159@8c129ef (v0.80.1), dal-go/dalgo2sql#181@b499a01 (v0.14.0), ingitdb/dalgo2ingitdb#9@a153d64 (v0.5.0), openvaultdb/openvaultdb-go#18@caeac4d (v0.5.0), datatug/datatug-cli#237@dc33880, datatug/datatug-cli#238@009f167 (v0.24.5), datatug/datatug-apps#138@3e61e80, datatug/datatug-apps#139@05d1c3f
**Note:** The provider-first publication and dependency-convergence wave is landed. All eight PRs used WB exact-head landing, passed post-target CI, synchronized their canonical clones, and retired their source worktrees. DataTug CLI consumes dalgo2sql v0.14.0, dalgo2ingitdb v0.5.0 and openvaultdb-go v0.5.0 without local replaces; the HTTP adapter remains on its immutable published-main pseudo-version because that commit has no tag. CLI v0.24.5 is public, and DataTug Apps' build, test, browser E2E, Workers build and real-CLI journey pass with that exact release. Independent review receipts are linked from datatug/datatug-cli#237. Task 24 remains in progress because current browser write/Explain convergence and final whole-chain acceptance are explicitly outstanding; SDK methods and lower-layer OVDB write tests are not browser E2E proof. Policy viewer/editor remains excluded. The remote WB HTTP hub lacks claim support; local Work Log cleanup succeeded.
...
**Annotation Amendment:** actor=codex; at=2026-09-12T06:03:23Z; reason=Record landed provider-first release and consumer convergence while retaining the explicit browser acceptance gap; before_sha256=46e0d0d8bcb98b201d7f60e519dd7c63f262ac61f4f546a40e8b354fd82fe630
## Open Questions
