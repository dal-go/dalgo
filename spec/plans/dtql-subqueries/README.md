...
**Status:** complete
**Note:** Spec and plan independently reviewed, lint-clean, and approved by Alex on 2026-09-21.
**Evidence:** spec/features/dtql-subqueries/README.md, spec/plans/dtql-subqueries/README.md
...
- Alex approved the quoted public-API justification and this plan on 2026-09-21.
- The JOIN owner landed Go PR #180 and DALgo-JS PR #3. Exact remote-main receipts are recorded above; the isolated subquery worktrees incorporate them. The shared hint field is retained.
