...
func (mr *MockReadTransactionMockRecorder) ExecuteQueryToRecordsReader(ctx, query any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExecuteQueryToRecordsReader", reflect.TypeOf((*MockReadTransaction)(nil).ExecuteQueryToRecordsReader), ctx, query)
}
...
func (mr *MockReadTransactionMockRecorder) ExecuteQueryToRecordsetReader(ctx, query any, options ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, query}, options...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExecuteQueryToRecordsetReader", reflect.TypeOf((*MockReadTransaction)(nil).ExecuteQueryToRecordsetReader), varargs...)
}
...
func (m *MockReadTransaction) Get(ctx context.Context, arg1 record.Record) error {
	m.ctrl.T.Helper()
...
func (mr *MockReadTransactionMockRecorder) Get(ctx, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockReadTransaction)(nil).Get), ctx, arg1)
}
...
// ExecuteQueryToRecordsReader indicates an expected call of ExecuteQueryToRecordsReader.
func (mr *MockReadwriteTransactionMockRecorder) ExecuteQueryToRecordsReader(ctx, query any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExecuteQueryToRecordsReader", reflect.TypeOf((*MockReadwriteTransaction)(nil).ExecuteQueryToRecordsReader), ctx, query)
}
...
// ExecuteQueryToRecordsetReader indicates an expected call of ExecuteQueryToRecordsetReader.
func (mr *MockReadwriteTransactionMockRecorder) ExecuteQueryToRecordsetReader(ctx, query any, options ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, query}, options...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExecuteQueryToRecordsetReader", reflect.TypeOf((*MockReadwriteTransaction)(nil).ExecuteQueryToRecordsetReader), varargs...)
}
...
// Get mocks base method.
func (m *MockReadwriteTransaction) Get(ctx context.Context, arg1 record.Record) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, arg1)
	ret0, _ := ret[0].(error)
	return ret0
...
// Get indicates an expected call of Get.
func (mr *MockReadwriteTransactionMockRecorder) Get(ctx, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockReadwriteTransaction)(nil).Get), ctx, arg1)
}
...
func (m *MockReadwriteTransaction) Insert(ctx context.Context, arg1 record.Record, opts ...dal.InsertOption) error {
	m.ctrl.T.Helper()
...
func (mr *MockReadwriteTransactionMockRecorder) Insert(ctx, arg1 any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockReadwriteTransaction) Set(ctx context.Context, arg1 record.Record) error {
	m.ctrl.T.Helper()
...
func (mr *MockReadwriteTransactionMockRecorder) Set(ctx, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Set", reflect.TypeOf((*MockReadwriteTransaction)(nil).Set), ctx, arg1)
}
...
func (m *MockReadwriteTransaction) UpdateRecord(ctx context.Context, arg1 record.Record, updates []update.Update, preconditions ...dal.Precondition) error {
	m.ctrl.T.Helper()
...
func (mr *MockReadwriteTransactionMockRecorder) UpdateRecord(ctx, arg1, updates any, preconditions ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
