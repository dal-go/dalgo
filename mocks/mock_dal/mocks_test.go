...
func TestMocks(t *testing.T) {
	...
	t.Run("MockDB", func(t *testing.T) {
		...
		m.EXPECT().ExecuteQueryToRecordsReader(ctx, gomock.Any()).Return(nil, nil).AnyTimes()
		m.EXPECT().ExecuteQueryToRecordsetReader(ctx, gomock.Any(), gomock.Any()).Return(nil, nil).AnyTimes()
