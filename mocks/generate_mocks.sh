...
mockgen github.com/dal-go/dalgo/dal RecordsReader > mock_dal/records_reader.go
mockgen github.com/dal-go/dalgo/dal RecordsetReader > mock_dal/recordset_reader.go
